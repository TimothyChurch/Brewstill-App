        ...
        return {
            ...
            menu : [
                {label: 'Dashboard', icon: 'pi pi-fw pi-home', to: '/'},
								...
								{label: 'Recipes', icon: 'pi pi-fw pi-pencil', to: '/recipes'},
								{label: 'Batches', icon: 'pi pi-fw pi-book', to: '/batches'},
								{label: 'Inventory', icon: 'pi pi-fw pi-list', to: '/inventory'},
								{label: 'Sales', icon: 'pi pi-fw pi-money-bill', to: '/sales'},
								{label: 'Reports', icon: 'pi pi-fw pi-book', to: '/reports'},
								{label: 'Calculators', icon: 'pi pi-fw pi-percentage', to: '/calculators'}
            ]
        }
    },
    watch: {
